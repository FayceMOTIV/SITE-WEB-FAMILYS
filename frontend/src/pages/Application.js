          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-4 sm:mb-6">
                Nos <span className="text-orange-400">Burgers Gourmets</span>
              </h2>
              <p className="text-gray-300 text-lg sm:text-xl lg:text-2xl max-w-3xl mx-auto">
                Commandez directement depuis l'application et profitez de nos créations artisanales
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mb-12">
              {/* Burger 1 */}
              <Card className="bg-white/10 backdrop-blur-sm border-orange-400/30 overflow-hidden hover:scale-105 transition-transform duration-300 cursor-pointer group">
                ...
                <CardContent className="p-4 sm:p-6">
                  <h3 className="text-white font-bold text-xl mb-2">Le King</h3>
                  <p className="text-gray-300 text-sm">Double steak, cheddar affiné, bacon croustillant</p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/10 backdrop-blur-sm border-orange-400/30 overflow-hidden hover:scale-105 transition-transform duration-300 cursor-pointer group">
                ...
                <CardContent className="p-4 sm:p-6">
                  <h3 className="text-white font-bold text-xl mb-2">Le Smaan</h3>
                  <p className="text-gray-300 text-sm">Steak mariné, raclette fondue, champignons frais</p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/10 backdrop-blur-sm border-orange-400/30 overflow-hidden hover:scale-105 transition-transform duration-300 cursor-pointer group">
                ...
                <CardContent className="p-4 sm:p-6">
                  <h3 className="text-white font-bold text-xl mb-2">Le Chicken Crispy</h3>
                  <p className="text-gray-300 text-sm">Poulet pané croustillant, sauce caesar</p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/10 backdrop-blur-sm border-orange-400/30 overflow-hidden hover:scale-105 transition-transform duration-300 cursor-pointer group">
                ...
                <CardContent className="p-4 sm:p-6">
                  <h3 className="text-white font-bold text-xl mb-2">Le Veggie Deluxe</h3>
                  <p className="text-gray-300 text-sm">Steak végétal, avocat, tomates confites</p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/10 backdrop-blur-sm border-orange-400/30 overflow-hidden hover:scale-105 transition-transform duration-300 cursor-pointer group">
                <div className="relative h-64 overflow-hidden">
                  <img 
                    src="https://images.pexels.com/photos/3616956/pexels-photo-3616956.jpeg"
                    alt="Burger Gourmet 5"
                    className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300"
                    loading="lazy"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                ...
                <CardContent className="p-4 sm:p-6">
                  <h3 className="text-white font-bold text-xl mb-2">Le Cheese</h3>
                  <p className="text-gray-300 text-sm">Triple cheddar, cornichons, sauce signature</p>
                </CardContent>
              </Card>

              {/* Call to Action */}
              <Card className="bg-gradient-to-br from-orange-500 to-red-600 border-orange-400/50 flex items-center justify-center hover:scale-105 transition-transform duration-300 cursor-pointer">
                <CardContent className="p-6 text-center">
                  <Smartphone className="text-white mx-auto mb-4" size={48} />
                  <h3 className="text-white font-bold text-2xl mb-3">Et bien plus encore !</h3>
                  <p className="text-white text-lg mb-4">Découvrez toute notre carte dans l'application</p>
                  <Button className="bg-white text-gray-900 hover:bg-yellow-300 font-bold px-6 py-3 rounded-lg">
                    Télécharger l'app
                  </Button>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/10 backdrop-blur-sm border-orange-400/30 max-w-3xl mx-auto">
                <CardContent className="p-6 sm:p-8">
                  <p className="text-white text-lg sm:text-xl font-semibold mb-2">
                    🍔 Commandez via l'app et gagnez 5% de remise en argent sur chaque commande !
                  </p>
                  <p className="text-gray-300">
                    Tous nos burgers sont préparés avec des ingrédients frais et de qualité
                  </p>
                </CardContent>
              </Card>
            </div>
