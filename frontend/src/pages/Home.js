...
const Home = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-orange-950 via-amber-950 to-red-950">
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-b from-amber-50 to-orange-100 animate-on-scroll">
        <div className="container mx-auto px-4">
      ...
      {/* Reviews Section */}
      <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-b from-orange-100 to-amber-100 animate-on-scroll">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8 sm:mb-12 md:mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4 px-2">
      ...
      {/* Hours Section */}
      <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-b from-amber-100 to-orange-50 animate-on-scroll">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8 sm:mb-12">
